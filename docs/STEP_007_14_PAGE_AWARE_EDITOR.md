...
- Editor now shows a page rail with Home, About, Projects, Case Study Detail, Resume, Skills, and Contact.
- Non-case-study pages open a lightweight page brief editor with purpose, sources, and editable draft copy.
- Case Study Detail is treated as a project-owned detail page and keeps the deeper section canvas with drag reorder, lock state, prompt editing, and section evidence.
...
6. Select Case Study Detail and confirm the section-based case-study editor appears.
