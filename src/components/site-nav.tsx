...
import { PortfolioProgress } from "@/components/portfolio-progress";
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-background/90 backdrop-blur">
      <div className="px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="mx-auto mt-3 flex max-w-7xl gap-1 overflow-x-auto pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" aria-label="Primary">
          {productRoutes.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  "inline-flex min-h-10 shrink-0 items-center rounded-md px-3 text-sm font-medium transition hover:bg-panel hover:text-ink",
